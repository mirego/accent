defmodule Movement.Mappers.Operation do
  ...
  def map(action = "new", current_translation, suggested_translation) do
    %Movement.Operation{
      ...
      message_context: suggested_translation.message_context
    }
  end
  ...
  def map(action, current_translation, suggested_translation) do
    %Movement.Operation{
      ...
      message_context: Map.get(suggested_translation, :message_context, current_translation.message_context)
    }
  end
end
