defmodule Accent.Endpoint do
  ...
  plug(Plug.Static, at: "/static", from: Application.app_dir(:accent, "priv/static"), gzip: false, only: ~w(images))
  plug(Plug.Static, at: "/", from: Application.app_dir(:accent, "priv/static/webapp"), gzip: false, only: ~w(assets index.html))
