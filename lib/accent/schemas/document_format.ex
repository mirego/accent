defmodule Accent.DocumentFormat do
  ...
  ## Examples
    ...
    ["simple_json", "json", "strings", "gettext", "rails_yml", "es6_module", "android_xml", "java_properties", "java_properties_xml", "csv", "php"]
  """
  ...
  ## Examples
    ...
    [
      ...
      %Accent.DocumentFormat{extension: "php", name: "PHP", slug: "php"}
    ]
  """
