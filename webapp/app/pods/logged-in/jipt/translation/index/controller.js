...
const FLASH_MESSAGE_CORRECT_SUCCESS = 'pods.translation.edit.flash_messages.correct_success';
const FLASH_MESSAGE_CORRECT_ERROR = 'pods.translation.edit.flash_messages.correct_error';

const FLASH_MESSAGE_UNCORRECT_SUCCESS = 'pods.translation.edit.flash_messages.uncorrect_success';
const FLASH_MESSAGE_UNCORRECT_ERROR = 'pods.translation.edit.flash_messages.uncorrect_error';
  ...
  actions: {
    ...
    uncorrectConflict() {
      ...
      return this.apolloMutate
        ...
        .then(() => this.flashMessages.success(this.i18n.t(FLASH_MESSAGE_UNCORRECT_SUCCESS)))
        .catch(() => this.flashMessages.error(this.i18n.t(FLASH_MESSAGE_UNCORRECT_ERROR)));
    },
